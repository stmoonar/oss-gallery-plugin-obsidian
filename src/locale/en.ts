export default {
	...
	"Region": "Region",
	"Aliyun OSS Region (e.g., oss-cn-hangzhou)": "Aliyun OSS Region (e.g., oss-cn-hangzhou)",
	"Path": "Path",
	"Path prefix for uploaded files (optional)": "Path prefix for uploaded files (optional)",
	"Custom domain for CDN (optional)": "Custom domain for CDN (optional)",
	"HTTP proxy URL (optional, required for CORS issues)": "HTTP proxy URL (optional, required for CORS issues)",
	"Please configure Aliyun OSS settings first": "Please configure Aliyun OSS settings first",
